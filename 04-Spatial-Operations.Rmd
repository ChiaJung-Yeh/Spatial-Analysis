...
```{r convex_hull_youbike_map, echo=F, eval=T, warning=F, fig.width=4, fig.height=4, dpi=200}
tmap_mode("view")
...
```{r voronoi_mrt_map, echo=F, eval=T, warning=F, fig.width=3, fig.height=3, dpi=120}
...
ggplot()+
  ...
  theme(panel.background=element_blank(),
        ...
        legend.text=element_text(size=18, family="A"))
